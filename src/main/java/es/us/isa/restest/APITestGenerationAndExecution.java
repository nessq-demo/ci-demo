 ...
 */
public class APITestGenerationAndExecution {
	...
	private static Logger logger = LogManager.getLogger(APITestGenerationAndExecution.class.getName());
	...
	public static void main(String[] args) throws Exception {
		...
		((APIChainRESTAssuredWriter) writer).setClassName(className);
		((APIChainRESTAssuredWriter) writer).setTestId(id);
